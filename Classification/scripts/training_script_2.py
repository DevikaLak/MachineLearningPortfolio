...
import autogluon.core as agcore
...
if __name__ == "__main__":
    ...
    hyperparameters = {
      'XGB' : {
                   'n_estimators': 15000,
                   'learning_rate': agcore.space.Real(0.01, 0.1, log=True),
                   'objective': 'binary:logistic',
                   'eval': 'auc',
                   'booster': 'gbtree',
                   'max_cat_to_onehot': agcore.space.Int(2, 4),
    ...
    predictor = TabularPredictor(**ag_predictor_args).fit(train_data, tuning_data=valid_data, hyperparameters=hyperparameters, hyperparameter_tune_kwargs=hyperparameter_tune_kwargs, **ag_fit_args)
